...
OUTPUT_PATH="${OUTPUT_PATH:-../experiments/inverse_kv_slot_mask_inference_step10000.json}"
...
MODES="${MODES:-full,same_slot_occurrence,same_slot,same_higher,same_slot_or_higher,random_same_size}"  # full/same_slot_occurrence/same_slot/same_higher/same_slot_or_higher/random_same_size
SLOT_LAYER="${SLOT_LAYER:-0}"
HIGHER_LAYER="${HIGHER_LAYER:-1}"
...
ARGS+=" --modes $MODES"
ARGS+=" --slot_layer $SLOT_LAYER"
ARGS+=" --higher_layer $HIGHER_LAYER"
ARGS+=" --random_seed $RANDOM_SEED"

python3 evaluate_slot_mask_inference.py ${ARGS}

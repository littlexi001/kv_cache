...
OUTPUT_PATH="${OUTPUT_PATH:-../experiments/feature_representations_baselines_step${CHECKPOINT_STEP}.json}"
...
PAIR_SAMPLES="${PAIR_SAMPLES:-200000}"
PROBE_TRAIN_FRACTION="${PROBE_TRAIN_FRACTION:-0.7}"
PCA_DIMS="${PCA_DIMS:-32}"
...
ARGS+=" --pair_samples $PAIR_SAMPLES"
ARGS+=" --probe_train_fraction $PROBE_TRAIN_FRACTION"
ARGS+=" --pca_dims $PCA_DIMS"
ARGS+=" --random_seed $RANDOM_SEED"

python3 analyze_feature_representations.py ${ARGS}

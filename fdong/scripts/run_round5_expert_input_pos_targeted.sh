...
echo "Round 5 targeted expert-input-position sweep start: $(date)"
...
echo "runs: 18 targeted cases"

# Best specialization router from the previous sweep.
run_case "k" "head" "attention_output_residual"
run_case "k" "head" "attention_output"
run_case "k" "head" "layer_input"
run_case "k" "head" "q"
run_case "k" "head" "k"
run_case "k" "head" "v"
run_case "k" "head" "hidden"

# Best predictive router from the previous sweep.
run_case "layer_input" "head" "attention_output_residual"
run_case "layer_input" "head" "attention_output"
run_case "layer_input" "head" "layer_input"
run_case "layer_input" "head" "q"
run_case "layer_input" "head" "k"
run_case "layer_input" "head" "v"
run_case "layer_input" "head" "hidden"

# Minimal controls to separate router-shape and router-position effects.
run_case "q" "head" "attention_output"
run_case "q" "head" "k"
run_case "k" "full" "attention_output"
run_case "layer_input" "full" "attention_output"

echo "Round 5 targeted expert-input-position sweep done: $(date)"

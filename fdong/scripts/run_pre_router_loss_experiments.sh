...
run_one() {
  ...
  local run_name="pre-router-${SYNTHETIC_SAMPLING_DISTRIBUTION}-${PRE_ROUTER_INPUT}-${loss_type}"
...
echo "==== done ===="
echo "logs: ../logs/pre-router-${SYNTHETIC_SAMPLING_DISTRIBUTION}-${PRE_ROUTER_INPUT}-*.log"
echo "checkpoints: ../checkpoints/pre-router-${SYNTHETIC_SAMPLING_DISTRIBUTION}-${PRE_ROUTER_INPUT}-*"

...
OUTPUT_PATH="${OUTPUT_PATH:-../experiments/singular_feature_alignment_baselines_step${CHECKPOINT_STEP}.json}"
...
TOPK_DIMS="${TOPK_DIMS:-1,2,5,10,20}"
MIN_FEATURE_COUNT="${MIN_FEATURE_COUNT:-8}"
...
ARGS+=" --topk_dims $TOPK_DIMS"
ARGS+=" --min_feature_count $MIN_FEATURE_COUNT"

python3 analyze_singular_feature_alignment.py ${ARGS}

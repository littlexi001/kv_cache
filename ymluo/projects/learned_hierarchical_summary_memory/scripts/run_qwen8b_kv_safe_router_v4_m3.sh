...
python ymluo/projects/learned_hierarchical_summary_memory/src/run_qwen8b_paper_benchmarks.py \
  --output_dir ymluo/projects/learned_hierarchical_summary_memory/outputs/qwen8b_kv_safe_router_v4_m3_20260707 \
  ...
  --router_path /home/fdong/ymluo/projects/learned_hierarchical_summary_memory/outputs/kv_safe_topk_router_v4_nonbench_20260707/router.pt \
  ...
  --methods full_raw,router_safe,recent_plus_retrieval_raw_k2,recent_plus_span_top3_b0_a0 \

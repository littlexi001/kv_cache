...
RUN_TAG="${RUN_TAG:-smallblock_router_m10_20260708}"
GPU_LIST="${GPU_LIST:-0 1 2 3}"
METHODS="${METHODS:-full_raw,router_blocksize,recent_plus_span_top3_b0_a0}"
...
declare -a JOBS=(
  "longbench|qwen8b_${RUN_TAG}_longbench|2026070811"
  "ruler4k|qwen8b_${RUN_TAG}_ruler4k|2026070812"
  "ruler8k|qwen8b_${RUN_TAG}_ruler8k|2026070813"
  "ruler16k|qwen8b_${RUN_TAG}_ruler16k|2026070814"
)
...
run_job() {
  ...
  mkdir -p "$out"
  echo "START group=$group gpu=$gpu out=$out router=$ROUTER $(date -Is)"
  (
...
echo "ALL SMALLBLOCK ROUTER M10 JOBS DONE $(date -Is)"

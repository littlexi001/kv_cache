...
python ymluo/projects/learned_hierarchical_summary_memory/src/run_qwen8b_paper_benchmarks.py \
  --output_dir ymluo/projects/learned_hierarchical_summary_memory/outputs/qwen8b_kv_safe_topk_actions_small_20260707 \
  ...
  --methods full_raw,recent_plus_retrieval_raw_k2,recent_plus_retrieval_raw_k3,recent_plus_span_top2_b0_a0,recent_plus_span_top2_b1_a0,recent_plus_span_top3_b0_a0,recent_plus_prefix_to_farthest_top2,recent_plus_prefix_to_farthest_top3,recent_plus_kv_safe_rule_v0,recent_plus_full_old_raw \

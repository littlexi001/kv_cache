...
python ymluo/projects/learned_hierarchical_summary_memory/src/run_fast_recent_plus_router_training.py \
  --output_dir ymluo/projects/learned_hierarchical_summary_memory/outputs/kv_safe_topk_router_nonbench_20260707 \
  ...
  --candidate_methods full_raw,recent_plus_summary1_8,recent_plus_retrieval_raw_k2,recent_plus_span_top2_b0_a0,recent_plus_span_top3_b0_a0,recent_plus_prefix_to_farthest_top3,recent_plus_full_old_raw \

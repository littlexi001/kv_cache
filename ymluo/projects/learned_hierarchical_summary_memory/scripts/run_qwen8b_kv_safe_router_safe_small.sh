...
python ymluo/projects/learned_hierarchical_summary_memory/src/run_qwen8b_paper_benchmarks.py \
  --output_dir ymluo/projects/learned_hierarchical_summary_memory/outputs/qwen8b_kv_safe_router_safe_small_20260707 \
  ...
  --methods full_raw,router,router_safe,recent_plus_retrieval_raw_k2,recent_plus_span_top3_b0_a0 \

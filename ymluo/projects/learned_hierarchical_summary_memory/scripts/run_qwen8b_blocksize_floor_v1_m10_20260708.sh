...
RUN_TAG="${RUN_TAG:-blocksize_floor_v1_m10_20260708}"
GPU_LIST="${GPU_LIST:-0 1 2 3}"
SELECT_GROUPS="${SELECT_GROUPS:-longbench ruler4k ruler8k ruler16k}"
METHODS="${METHODS:-full_raw,router_blocksize,router_blocksize_floor_v1}"
...
make_spec() {
  local group="$1"
  case "$group" in
    longbench) echo "longbench|qwen8b_${RUN_TAG}_longbench|2026070831" ;;
    ruler4k) echo "ruler4k|qwen8b_${RUN_TAG}_ruler4k|2026070832" ;;
    ruler8k) echo "ruler8k|qwen8b_${RUN_TAG}_ruler8k|2026070833" ;;
    ruler16k) echo "ruler16k|qwen8b_${RUN_TAG}_ruler16k|2026070834" ;;
...
echo "ALL BLOCKSIZE FLOOR V1 JOBS DONE $(date -Is)"

...
python ymluo/projects/learned_hierarchical_summary_memory/src/run_qwen8b_paper_benchmarks.py \
  --output_dir ymluo/projects/learned_hierarchical_summary_memory/outputs/qwen8b_blocksize_router_m3_20260707 \
  ...
  --router_path /home/fdong/ymluo/projects/learned_hierarchical_summary_memory/outputs/blocksize_router_from_sweeps_m3_20260707/router.pt \
  ...
  --methods full_raw,router_blocksize,recent_plus_span_top3_b0_a0 \

...
python "${PROJECT_DIR}/src/eval_structured_language.py" \
  --config_dir "${CONFIG_DIR:-${REPO_ROOT}/fdong/Qwen3-0.6B}" \
  --ckpt_file "${CKPT_FILE:-${PROJECT_DIR}/outputs/train/structured-language-attn-cluster/checkpoints/10000.pth}" \

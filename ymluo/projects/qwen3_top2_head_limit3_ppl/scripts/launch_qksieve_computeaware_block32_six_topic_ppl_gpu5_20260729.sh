...
RUN_ROOT=$ROOT/results/20260729_qksieve_computeaware_block32_six_topic_ppl_32k
...
"$PYTHON" -u src/run_direct_countcap_denseprompt_ppl_20260725.py \
  ...
  --direct_score_mode \
    pca_hierarchical_autoqmsetotal15z_qkmetric_cold84freqblock32hot15_packed_fulltopk \

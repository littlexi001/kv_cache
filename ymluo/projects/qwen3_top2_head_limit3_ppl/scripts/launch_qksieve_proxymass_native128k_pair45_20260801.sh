...
VARIANTS="qksieve_keymse_requestlocal_sampled_k1280_c32,qksieve_keymse_requestlocal_proxymass_k1280_c32"
...
for item in "computer|20260823" "mixed_b|20260826"; do
...
touch "${RUN_ROOT}/PAIR45_COMPLETE"

...
CUDA_VISIBLE_DEVICES=${GPU_V67:-0} nohup "$PY" src/run_controlled_public_kv_benchmark_v1.py \
  "${common_args[@]}" \
  --output_dir "outputs/riskkv_v67_coverage_risk_gate_qasper_full_m20_20260709" \
  --ours_task_policy_json configs/riskkv_task_policy_v67_coverage_risk_gate_qasper_full_20260709.json \
  > logs/riskkv_v67_coverage_risk_gate_qasper_full_m20_20260709.log 2>&1 < /dev/null &
echo "V67_COVERAGE_RISK_M20_PID=$!"

CUDA_VISIBLE_DEVICES=${GPU_V68:-1} nohup "$PY" src/run_controlled_public_kv_benchmark_v1.py \
  "${common_args[@]}" \
  --output_dir "outputs/riskkv_v68_coverage_mmr_risk_gate_qasper_full_m20_20260709" \
  --ours_task_policy_json configs/riskkv_task_policy_v68_coverage_mmr_risk_gate_qasper_full_20260709.json \
  > logs/riskkv_v68_coverage_mmr_risk_gate_qasper_full_m20_20260709.log 2>&1 < /dev/null &
echo "V68_COVERAGE_MMR_RISK_M20_PID=$!"

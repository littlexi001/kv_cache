...
RUN_ROOT="${RUN_ROOT:-${ROOT}/results/20260804_qksieve_deterministic_truec64_length_4gpu_v1}"
...
GPU_PAIR_64K="${GPU_PAIR_64K:-0,1}"
GPU_PAIR_128K="${GPU_PAIR_128K:-2,3}"
...
run_case "${GPU_PAIR_64K}" 65536 & p0=$!
run_case "${GPU_PAIR_128K}" 131040 & p1=$!

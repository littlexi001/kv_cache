...
LOG=${LOG:-logs/watch_and_launch_v84_qasper3072_retry_20260709.log}
LAUNCH_LOCK=${LAUNCH_LOCK:-logs/riskkv_gpu_launch.lock}
MAX_WAIT_LOOPS=${MAX_WAIT_LOOPS:-720}
NAME=${NAME:-riskkv_v84_v72_qasper3072_m20_retry_20260709}
POLICY=${POLICY:-configs/riskkv_task_policy_v84_v72_qasper3072_20260709.json}
...
{
  echo "[$(date)] v84 qasper3072 retry watcher started"

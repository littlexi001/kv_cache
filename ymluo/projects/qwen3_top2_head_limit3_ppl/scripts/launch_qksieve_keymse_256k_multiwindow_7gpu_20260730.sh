...
HIGHBIT_TEMPLATE="${HIGHBIT_TEMPLATE:-}"
RUN_ROOT="${RUN_ROOT:-${PROJECT_ROOT}/results/20260730_qksieve_keymse_256k_multiwindow_7gpu}"
...
VARIANTS="${VARIANTS:-qksieve_deploy_keymse_k10240_c64,qksieve_deploy_keymse_k15728_c64,qksieve_deploy_keymse_k20972_c64,qksieve_deploy_keymse_k26214_c64,qksieve_deploy_keymse_k31456_c64}"
...
run_window() {
  ...
  local extra_args=()
  if [[ -n "${HIGHBIT_TEMPLATE}" ]]; then
    extra_args+=(--highbit_template "${HIGHBIT_TEMPLATE}")
  fi

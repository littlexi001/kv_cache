...
OUTPUT="$ROOT/results/20260802_jointkv_all_layer_ppl/remote_4k_hutchinson"
...
COMMON=(
  ...
  --head_sensitivity_mode one_shot_hutchinson
...
run_one 0 tau0025_probe1_harmonic 0.025 1 &
run_one 1 tau0025_probe2_harmonic 0.025 2 &
run_one 2 tau0035_probe1_harmonic 0.035 1 &
run_one 3 tau0035_probe2_harmonic 0.035 2 &
wait

...
run_case server_pcic_war_b2_horizongate_s64_seed64_g0_r0_eager \
  data/war_and_peace_pg2600.txt \
  '7,6;0,13;0,7;0,6'

run_case server_pcic_monte_b2_horizongate_s64_seed64_g0_r0_eager \
...
cases = [
    ("war", pathlib.Path("outputs/server_pcic_war_b2_horizongate_s64_seed64_g0_r0_eager/pcic_r_blockwise_results.csv")),
    ("monte", pathlib.Path("outputs/server_pcic_monte_b2_horizongate_s64_seed64_g0_r0_eager/pcic_r_blockwise_results.csv")),
]

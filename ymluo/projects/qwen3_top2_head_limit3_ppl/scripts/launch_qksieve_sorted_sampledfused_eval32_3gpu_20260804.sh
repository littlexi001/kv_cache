...
RUN_ROOT="${RUN_ROOT:-${ROOT}/results/20260804_qksieve_sorted_sampledfused_eval32_3gpu_v1}"
...
run_case() {
  ...
  CUDA_VISIBLE_DEVICES="${gpu}" "${PYTHON}" -u \
    ...
    --variants "qksieve_qmse_oas_requestlocal_valuesketch16_k1280,qksieve_qmse_oas_requestlocal_valuesketch16_sorted_s1024_k1280" \

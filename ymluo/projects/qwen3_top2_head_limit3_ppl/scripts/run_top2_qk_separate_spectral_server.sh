...
OUT="${OUT:-/home/fdong/ymluo/projects/qwen3_top2_head_limit3_ppl/outputs/top2_qk_separate_spectral_smoke_0630}"
mkdir -p "$OUT"
...
nohup python -u src/analyze_top2_qk_separate_spectral.py \

...
RUN_ROOT=$ROOT/results/20260724_periodic_reuse_ceiling_8k32k_3gpu
BASE=countcap_fullprompt_keypca_direct_qkvfused_prefillindex
REUSE2=countcap_fullprompt_keypca_direct_qkvfused_reuse2_prefillindex
REUSE4=countcap_fullprompt_keypca_direct_qkvfused_reuse4_prefillindex
REUSE8=countcap_fullprompt_keypca_direct_qkvfused_reuse8_prefillindex
...
for spec in "0:8192" "1:16000" "2:32000"; do
  ...
  mkdir -p "$out"
  methods="full_kv,$BASE,$REUSE2,$REUSE4,$REUSE8"

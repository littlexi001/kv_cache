...
STAMP="${STAMP:-20260703_e2e_timing_v8}"
MODEL="${MODEL:-/home/fdong/hrj/prove/Qwen3-0.6B}"
PY="${PY:-python}"
CONTEXT_TOKENS="${CONTEXT_TOKENS:-10000,20000,39000}"
...
# Memory hierarchy update policy:
# L0 current page: online append; represented as unsealed tail in production.
# L1 page: seal at natural paragraph boundary, bounded by 256-1024 tokens.
# L2 section: every 8 L1 pages by default.
# L3 chapter/document: every 64 L1 pages by default.
# Global memory index: batch every 128 L1 pages by default.
...
OUT="outputs/range_sdpa_e2e_timing_v8_${STAMP}"
LOG="outputs/logs/range_sdpa_e2e_timing_v8_${STAMP}.log"

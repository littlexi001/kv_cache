...
LOG=${LOG:-logs/watch_and_launch_v70_grounded_qa_20260709.log}
LAUNCH_LOCK=${LAUNCH_LOCK:-logs/riskkv_gpu_launch.lock}
MAX_WAIT_LOOPS=${MAX_WAIT_LOOPS:-720}
NAME=${NAME:-riskkv_v70_grounded_qa_verifier_qasper_full_m20_20260709}
...
{
  echo "[$(date)] v70 grounded QA watcher started"

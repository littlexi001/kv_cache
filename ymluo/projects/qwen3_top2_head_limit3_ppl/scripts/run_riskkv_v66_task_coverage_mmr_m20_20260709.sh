...
CUDA_VISIBLE_DEVICES="$GPU" nohup "$PY" src/run_controlled_public_kv_benchmark_v1.py \
  ...
  --log_every 20 \
  --output_dir "outputs/riskkv_v66_task_coverage_mmr_benefit_conformal_qasper_full_m20_20260709" \
  --ours_task_policy_json configs/riskkv_task_policy_v66_task_coverage_mmr_benefit_conformal_qasper_full_20260709.json \
  > logs/riskkv_v66_task_coverage_mmr_benefit_conformal_qasper_full_m20_20260709.log 2>&1 < /dev/null &

echo "V66_TASK_COVERAGE_MMR_M20_PID=$!"

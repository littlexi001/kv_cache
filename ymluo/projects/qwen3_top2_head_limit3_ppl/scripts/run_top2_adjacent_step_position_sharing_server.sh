...
OUT="${OUT:-/home/fdong/ymluo/projects/qwen3_top2_head_limit3_ppl/outputs/top2_adjacent_step_position_sharing_war_4k_v1}"
mkdir -p "$OUT"
...
nohup python -u src/analyze_top2_adjacent_step_position_sharing.py \
  ...
  --write_query_layer_head_metrics "${WRITE_QUERY_LAYER_HEAD_METRICS:-false}" \

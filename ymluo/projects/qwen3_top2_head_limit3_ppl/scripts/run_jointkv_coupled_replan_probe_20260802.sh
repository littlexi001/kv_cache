...
ACTION=${ACTION:-joint_cost_replan}
TAG=${TAG:-replan}
FEEDBACK_SOURCE=${FEEDBACK_SOURCE:-first_decode}
OUTPUT=${OUTPUT:-$ROOT/results/20260802_jointkv_coupled_replan_probe}
...
COMMON=(
  ...
  --adaptive_error_tolerance 0.05 --adaptive_action_mode "$ACTION"
  ...
  --one_shot_feedback_source "$FEEDBACK_SOURCE"
)
...
run_one 0 "q06_author_4k_e16_$TAG" "$MODEL06" "$CACHE06" qksieve_author_text.txt 4096 16 &
run_one 1 "q06_biomed_8k_e16_$TAG" "$MODEL06" "$CACHE06" biomed_long_range_facts_hard_compact.txt 8192 16 &
run_one 2 "q06_compiler_8k_e16_$TAG" "$MODEL06" "$CACHE06" compiler_long_range_facts_hard_compact.txt 8192 16 &
run_one 3 "q06_geology_8k_e16_$TAG" "$MODEL06" "$CACHE06" geology_long_range_facts_hard_compact.txt 8192 16 &
run_one 4 "q8_author_4k_e16_$TAG" "$MODEL8" "$CACHE8" qksieve_author_text.txt 4096 16 &
run_one 5 "q8_author_8k_e8_$TAG" "$MODEL8" "$CACHE8" qksieve_author_text.txt 8192 8 &
run_one 6 "q8_compiler_8k_e8_$TAG" "$MODEL8" "$CACHE8" compiler_long_range_facts_hard_compact.txt 8192 8 &
run_one 7 "q8_geology_8k_e8_$TAG" "$MODEL8" "$CACHE8" geology_long_range_facts_hard_compact.txt 8192 8 &
wait

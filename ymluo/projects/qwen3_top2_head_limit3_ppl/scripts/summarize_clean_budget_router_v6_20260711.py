...
def main() -> None:
    ...
    out_path = ROOT / "outputs/riskkv_v19_learned_budget_router_v6_compare_summary_20260711.csv"
    ...
    test_rows.sort(key=lambda row: (float(row["score_ratio"]), -float(row["learned_kv"])), reverse=True)

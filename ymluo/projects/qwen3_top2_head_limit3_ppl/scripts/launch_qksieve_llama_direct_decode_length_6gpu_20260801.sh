...
RUN_ROOT="${RUN_ROOT:-${ROOT}/results/20260801_qksieve_llama31_direct_decode_length_6gpu}"
...
# One GPU is enough through 16K; longer cases use two GPUs. The 32K and
# 64K cases run serially on the same pair so the launcher stays within GPU 0-5.
workers=(
  "0|8192"
  "1|16384"
  "2,3|32768,65536"
...
for worker in "${workers[@]}"; do
  ...
  (
    ...
    for length in "${length_values[@]}"; do
      ...
      variant="qksieve_keymse_requestlocal_fulltopk_k${budget}"

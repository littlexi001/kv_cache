...
OUT=/home/fdong/ymluo/projects/qwen3_top2_head_limit3_ppl/outputs/oracle_span_retention_qabs5_shortctx_v1
mkdir -p "$OUT"
...
nohup python -u src/run_qabs_oracle_span_retention.py \

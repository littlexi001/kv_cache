...
run_one 0 server_pcic_hardtopic_b8_conffast_s8_seed64_allm01_pairm005_slack03_delta005_eager \
  "${COMMON[@]}" \
  --output_dir outputs/server_pcic_hardtopic_b8_conffast_s8_seed64_allm01_pairm005_slack03_delta005_eager \
  --prefill_tokens 2048 --num_blocks 8 --calibration_tokens 16 --eval_tokens_per_block 64 &

run_one 1 server_pcic_hardtopic_b4_eval128_conffast_s8_seed64_allm01_pairm005_slack03_delta005_eager \
  "${COMMON[@]}" \
  --output_dir outputs/server_pcic_hardtopic_b4_eval128_conffast_s8_seed64_allm01_pairm005_slack03_delta005_eager \
...
runs = [
    ("hardtopic b4 conffast", "outputs/server_pcic_hardtopic_b4_conffast_s8_seed64_allm01_pairm005_slack03_delta005_eager"),
    ("hardtopic b8 conffast", "outputs/server_pcic_hardtopic_b8_conffast_s8_seed64_allm01_pairm005_slack03_delta005_eager"),
    ("hardtopic eval128 conffast", "outputs/server_pcic_hardtopic_b4_eval128_conffast_s8_seed64_allm01_pairm005_slack03_delta005_eager"),
]

print("| run | blocks | avg_delta_ppl | method/base | combos | triggered |")
print("|---|---:|---:|---:|---|---:|")
for label, directory in runs:
    ...
    print(
        ...
        f"{';'.join(row['combo'] for row in evals)} | {triggered} |"
    )
PY

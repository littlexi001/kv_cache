...
def main() -> None:
    ...
    for path in sorted((ROOT / "outputs").glob("riskkv_v19_learned_budget_router_v4_clean_budget_preselection_*_20260711")):
    ...
    out_path = ROOT / "outputs/riskkv_v19_learned_budget_router_v4_clean_budget_summary_20260711.csv"

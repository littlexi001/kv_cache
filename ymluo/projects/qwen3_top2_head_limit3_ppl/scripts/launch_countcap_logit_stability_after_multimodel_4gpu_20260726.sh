...
PARENT_RUN=$ROOT/results/20260726_final_direct_multimodel_m100_ctx7500
RUN_ROOT=$ROOT/results/20260726_countcap_logit_stability_32k_4gpu
...
print("validated 3072 paired token-logit comparisons")
PY

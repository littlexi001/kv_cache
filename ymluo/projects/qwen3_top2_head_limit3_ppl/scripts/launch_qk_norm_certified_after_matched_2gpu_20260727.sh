...
PREREQUISITE=$ROOT/results/20260727_qk_matched_rate_all_dims_32k
TRACE_ROOT=$ROOT/results/20260727_qkv_value_sensitive_32k/traces
RUN_ROOT=$ROOT/results/20260727_qk_norm_certified_refinement_32k
...
while [[ ! -e "$PREREQUISITE/ALL_COMPLETE" ]]; do
  if ! pgrep -f '^bash scripts/launch_qk_matched_rate_after_physical_2gpu_20260727.sh$' >/dev/null; then

...
RUN_ROOT="${RUN_ROOT:-${PROJECT_ROOT}/results/20260730_qksieve_keymse_256k_budget_frontier_7gpu}"
...
VARIANTS="${VARIANTS:-qksieve_keymse_fulltopk,qksieve_deploy_keymse_k1280,qksieve_deploy_keymse_k1280_s4096,qksieve_deploy_keymse_k2560,qksieve_deploy_keymse_k3840,qksieve_deploy_keymse_k5120,qksieve_deploy_keymse_k7680}"

...
OUTPUT="$ROOT/results/20260802_jointkv_projected_feedback_probe"
...
run_one() {
  local gpu=$1 name=$2 model=$3 cache=$4 text=$5 history=$6 eval_tokens=$7 norm=$8
  CUDA_VISIBLE_DEVICES="$gpu" OMP_NUM_THREADS=1 MKL_NUM_THREADS=1 \
    ...
    --one_shot_feedback_norm "$norm" --output "$OUTPUT/$name.json" \
    >"$OUTPUT/$name.log" 2>&1
}

run_one 0 q06_author_4k_e16_global "$MODEL06" "$CACHE06" qksieve_author_text.txt 4096 16 projected_layer_global &
run_one 1 q06_author_4k_e16_rss "$MODEL06" "$CACHE06" qksieve_author_text.txt 4096 16 projected_layer_rss &
run_one 2 q06_biomed_8k_e16_global "$MODEL06" "$CACHE06" biomed_long_range_facts_hard_compact.txt 8192 16 projected_layer_global &
run_one 3 q06_biomed_8k_e16_rss "$MODEL06" "$CACHE06" biomed_long_range_facts_hard_compact.txt 8192 16 projected_layer_rss &
run_one 4 q8_author_4k_e16_global "$MODEL8" "$CACHE8" qksieve_author_text.txt 4096 16 projected_layer_global &
run_one 5 q8_author_4k_e16_rss "$MODEL8" "$CACHE8" qksieve_author_text.txt 4096 16 projected_layer_rss &
run_one 6 q8_author_8k_e8_global "$MODEL8" "$CACHE8" qksieve_author_text.txt 8192 8 projected_layer_global &
run_one 7 q8_author_8k_e8_rss "$MODEL8" "$CACHE8" qksieve_author_text.txt 8192 8 projected_layer_rss &
wait

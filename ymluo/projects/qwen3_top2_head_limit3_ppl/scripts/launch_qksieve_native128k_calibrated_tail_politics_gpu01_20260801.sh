...
RUN_ROOT="${RUN_ROOT:-${ROOT}/results/20260801_qksieve_native128k_calibrated_tail_politics_gpu01}"
DATASET_CACHE_DIR="${DATASET_CACHE_DIR:-/home/fdong/ymluo/datasets/sklearn}"
VARIANTS="qksieve_keymse_requestlocal_fulltopk_k1280,qksieve_keymse_requestlocal_blockmass64_fulltopk_k1280,qksieve_keymse_requestlocal_blockcalmass64_fulltopk_k1280,qksieve_keymse_requestlocal_blocksharedcalmass64_fulltopk_k1280,qksieve_keymse_requestlocal_blocksharedcalmass128_fulltopk_k1280"

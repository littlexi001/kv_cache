...
def main() -> None:
    ...
    patterns = [
        "riskkv_v19_learned_budget_router_v11_m100_preselection_*_20260711",
    ]
    ...
    out_path = ROOT / "outputs/riskkv_v19_learned_budget_router_v11_m100_compare_summary_20260711.csv"

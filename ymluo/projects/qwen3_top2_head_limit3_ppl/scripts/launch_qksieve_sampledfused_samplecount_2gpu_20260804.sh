...
RUN_ROOT="${RUN_ROOT:-${ROOT}/results/20260804_qksieve_sampledfused_samplecount_2gpu_v1}"
...
run_case() {
  ...
  local topic="$2"
  local seed="$3"
  local output_dir="${RUN_ROOT}/${topic}32k"
  CUDA_VISIBLE_DEVICES="${gpu}" "${PYTHON}" -u \
    ...
    --variants "qksieve_qmse_oas_requestlocal_valuesketch16_sampled_k1280,qksieve_qmse_oas_requestlocal_valuesketch16_sampled_s512_k1280,qksieve_qmse_oas_requestlocal_valuesketch16_sampled_s1024_k1280" \
    >"${RUN_ROOT}/logs/${topic}32k.log" 2>&1
  touch "${output_dir}/ALL_COMPLETE"
}

run_case 0 medicine 20261403 & p0=$!
run_case 1 sports 20261404 & p1=$!

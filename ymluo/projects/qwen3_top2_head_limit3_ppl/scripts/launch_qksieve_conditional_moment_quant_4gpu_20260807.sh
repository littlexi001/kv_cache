...
OUTPUT="${OUTPUT:-$ROOT/results/conditional_moment_quant_realqkv_20260807}"
...
run_condition() {
  ...
  local top_k="$3"
  local moment_bits="$4"
  local condition="r${rank}_k${top_k}_m${moment_bits}"
...
run_condition 0 8 1120 16 & pid0=$!
run_condition 1 8 1120 8 & pid1=$!
run_condition 2 8 1120 4 & pid2=$!
run_condition 3 4 1280 8 & pid3=$!

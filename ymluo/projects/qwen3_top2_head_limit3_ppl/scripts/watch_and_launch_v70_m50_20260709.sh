...
LOG=${LOG:-logs/watch_and_launch_v70_m50_20260709.log}
LAUNCH_LOCK=${LAUNCH_LOCK:-logs/riskkv_gpu_launch.lock}
MAX_WAIT_LOOPS=${MAX_WAIT_LOOPS:-720}
NAME=${NAME:-riskkv_v70_grounded_qa_verifier_qasper_full_m50_20260709}
POLICY=${POLICY:-configs/riskkv_task_policy_v70_grounded_qa_verifier_qasper_full_20260709.json}
...
{
  echo "[$(date)] v70 m50 watcher started"

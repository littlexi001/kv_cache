...
RUN_ROOT="${RUN_ROOT:-${ROOT}/results/20260801_qksieve_valuesketch_32k_six_topic_gpu2}"
DATASET_CACHE_DIR="${DATASET_CACHE_DIR:-/home/fdong/ymluo/datasets/sklearn}"
VARIANTS="qksieve_keymse_requestlocal_fulltopk_k1280,qksieve_keymse_requestlocal_valuesketch8i4_fulltopk_k1280,qksieve_keymse_requestlocal_valuesketch16i4_fulltopk_k1280"
CASES=(
  "computer|20260833"
  "medicine|20260832"
  "mixed_b|20260836"

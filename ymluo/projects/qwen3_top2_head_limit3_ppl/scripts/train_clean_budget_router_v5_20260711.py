...
def train(task_encoding: str, confidence: str, max_depth: int, min_samples_leaf: int) -> None:
    ...
    output_dir = (
        f"outputs/riskkv_v19_learned_budget_router_v5_clean_budget_"
...
def main() -> None:
    for confidence in ["0.0", "0.25", "0.35", "0.50", "0.65"]:
        train("both", confidence, max_depth=6, min_samples_leaf=2)
    for confidence in ["0.0", "0.25", "0.35", "0.50", "0.65"]:
        train("family", confidence, max_depth=5, min_samples_leaf=2)

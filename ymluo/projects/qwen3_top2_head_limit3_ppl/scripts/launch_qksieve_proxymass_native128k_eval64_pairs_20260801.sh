...
RUN_ROOT="${RUN_ROOT:-${ROOT}/results/20260801_qksieve_proxymass_native128k_eval64_6domain}"
DATASET_CACHE_DIR="${DATASET_CACHE_DIR:-/home/fdong/ymluo/datasets/sklearn}"
PAIR_SET="${PAIR_SET:-all}"
PAIR01_GPUS="${PAIR01_GPUS:-0,1}"
VARIANTS="qksieve_keymse_requestlocal_fulltopk_k1280,qksieve_keymse_requestlocal_sampled_k1280_c32,qksieve_keymse_requestlocal_proxymass_k1280_c32"
...
case "${PAIR_SET}" in
  all)
    workers=(
      ...
      "2,3|sports_both|20260831|politics|20260834"
      "4,5|medicine|20260832|religion|20260835"
    )
    ;;
  01)
    workers=("${PAIR01_GPUS}|computer|20260833|mixed_b|20260836")
    ;;
  2345)
    workers=(
      "2,3|sports_both|20260831|politics|20260834"
    ...
    ;;
  *)
    echo "PAIR_SET must be one of: all, 01, 2345" >&2
    exit 2
    ;;
esac
...
touch "${RUN_ROOT}/PAIR_SET_${PAIR_SET}_COMPLETE"

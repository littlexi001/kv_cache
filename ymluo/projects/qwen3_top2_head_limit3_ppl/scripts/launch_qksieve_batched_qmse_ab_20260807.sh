...
EXPERIMENT_ROOT="${EXPERIMENT_ROOT:-${ROOT}/experiments/batched_qmse_20260807}"
RUN_ROOT="${RUN_ROOT:-${ROOT}/results/qksieve_batched_qmse_ab_32k_20260807}"
GPU="${GPU:-0}"
...
run_case() {
  ...
  QKSIEVE_BATCH_QMSE_ALLOCATION="${batched}" \
...
"${PYTHON}" "${EXPERIMENT_ROOT}/src/summarize_qksieve_batched_qmse_ab_20260807.py" \

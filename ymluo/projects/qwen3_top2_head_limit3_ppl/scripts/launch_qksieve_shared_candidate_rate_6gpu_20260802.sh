...
RUN_ROOT="${RUN_ROOT:-${ROOT}/results/20260802_qksieve_shared_candidate_rate_6gpu}"
...
SPECS=(
  "fixed400_b80|per_head"
  "fixed400_b80|gqa_shared_max"
  "fixed410_b112|per_head"
  "fixed410_b112|gqa_shared_max"
  "fixed4421_b240|per_head"
  "fixed4421_b240|gqa_shared_max"
)
...
for gpu in 0 1 2 3 4 5; do
  IFS='|' read -r profile policy <<<"${SPECS[$gpu]}"
  tag="${profile}_${policy}"

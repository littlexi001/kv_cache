...
RUN_ROOT="${RUN_ROOT:-${ROOT}/results/20260801_qksieve_native128k_budget_qmse_politics_gpu02}"
DATASET_CACHE_DIR="${DATASET_CACHE_DIR:-/home/fdong/ymluo/datasets/sklearn}"
GPU_PAIR="${GPU_PAIR:-0,2}"
VARIANTS="exact_qk_oracle_k5120,exact_qk_oracle_k10240,exact_qk_oracle_k16384,qksieve_keymse_requestlocal_fulltopk_k5120,qksieve_qmse_requestlocal_fulltopk_k1280,qksieve_qmse_requestlocal_fulltopk_k5120"

...
RUN_ROOT="${RUN_ROOT:-${ROOT}/results/20260801_qksieve_valuesketch_native128k_v25_corrected_6gpu}"
RUNNER="${ROOT}/scripts/run_qksieve_native128k_valuesketch_topics_20260801.sh"
VARIANTS="qksieve_keymse_requestlocal_valuesketch8i4_sampled_k1280,qksieve_keymse_requestlocal_valuesketch32i4_sampled_k1280"

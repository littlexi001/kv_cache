...
OUT="${OUT:-/home/fdong/ymluo/projects/qwen3_top2_head_limit3_ppl/outputs/top2_spectral_token_groups_smoke_0630}"
mkdir -p "$OUT"
...
nohup python -u src/analyze_top2_spectral_token_groups.py \
  ...
  --layers "${LAYERS:-0,4,5,7,8,13,14,16,20,27}" \
  --heads "${HEADS:-all}" \

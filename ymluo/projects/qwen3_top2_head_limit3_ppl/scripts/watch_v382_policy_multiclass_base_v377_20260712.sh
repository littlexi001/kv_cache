...
STAMP="${STAMP:-20260712_policy_multiclass_base_v377_v382}"
LABEL="${LABEL:-v382_policy_multiclass_base_v377}"
POLICY="${POLICY:-configs/riskkv_task_policy_v382_policy_multiclass_base_v377_20260712.json}"
...
echo "TRAIN_V382_START $(date -Is)"
"$PY" scripts/train_policy_multiclass_router_v382_20260712.py
echo "TRAIN_V382_DONE $(date -Is)"
...
full_online = 3.0988
full_score = 0.3658
path = Path("outputs/riskkv_v19_v382_policy_multiclass_base_v377_20260712_policy_multiclass_base_v377_v382_m20_bDyn_pDyn/task_results.csv")
flag = Path("outputs/riskkv_v19_v382_policy_multiclass_base_v377_m100_gate_20260712.flag")
...
flag.write_text("1\n" if passed else "0\n", encoding="utf-8")
print(
    f"V382_M20_GATE score={score:.4f} vs_full={score/full_score:.2%} "
    f"kv={kv:.2%} speed_full={speed:.2f}x passed={passed}"
)
PY

if [[ "$(cat outputs/riskkv_v19_v382_policy_multiclass_base_v377_m100_gate_20260712.flag)" == "1" ]]; then
  launch_sync 100
else
  echo "SKIP v382 M100 because M20 gate failed $(date -Is)"
fi

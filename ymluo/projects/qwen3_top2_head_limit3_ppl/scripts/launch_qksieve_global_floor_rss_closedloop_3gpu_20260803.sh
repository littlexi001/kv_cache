...
OUTPUT="${OUTPUT:-${ROOT}/results/20260803_qksieve_global_floor_rss_closedloop_3gpu_v1}"
DATASET_CACHE_DIR="${DATASET_CACHE_DIR:-/home/fdong/ymluo/datasets/sklearn}"
VARIANTS="qksieve_keymse_requestlocal_valuesketch16i4_wometric_fulltopk_k1280,qksieve_keymse_requestlocal_valuesketch16i4_wometric_residualrisk4_globalfloorrss25e4_safety1_fulltopk_k1280"
...
run_case 0 religion4k "${LLAMA_MODEL}" religion 4096 8 20260835 & pid0=$!
run_case 1 sports32k "${QWEN_MODEL}" sports 32000 8 20260831 & pid1=$!
run_case 2 medicine32k "${QWEN_MODEL}" medicine 32000 8 20260832 & pid2=$!

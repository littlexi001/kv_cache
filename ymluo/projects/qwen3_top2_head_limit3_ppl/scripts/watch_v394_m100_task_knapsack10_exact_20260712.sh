...
GPUS="${GPUS:-4,6,7,2,0,1,3,5}"
RUNNER="${RUNNER:-scripts/run_riskkv_task_policy_v19_one_20260709.sh}"
STAMP="${STAMP:-20260712_m100_task_knapsack10_exact_v394}"
LABEL="${LABEL:-v394_m100_task_knapsack10_exact}"
POLICY="${POLICY:-configs/riskkv_task_policy_v394_m100_task_knapsack10_exact_20260712.json}"
...
full_score = 0.3658
full_online = 3.0988
path = Path("outputs/riskkv_v19_v394_m100_task_knapsack10_exact_20260712_m100_task_knapsack10_exact_v394_m20_bDyn_pDyn/task_results.csv")
flag = Path("outputs/riskkv_v19_v394_m100_task_knapsack10_exact_m100_gate_20260712.flag")
...
flag.write_text("1\n" if passed else "0\n", encoding="utf-8")
print(f"V394_M20_GATE score={score:.4f} vs_full={score/full_score:.2%} kv={kv:.2%} speed_full={speed:.2f}x passed={passed}")
PY

if [[ "$(cat outputs/riskkv_v19_v394_m100_task_knapsack10_exact_m100_gate_20260712.flag)" == "1" ]]; then
  launch_sync 100
else
  echo "SKIP v394 M100 because M20 gate failed $(date -Is)"
fi

...
LOG=${LOG:-logs/watch_and_launch_v78_coverage_certificate_20260709.log}
LAUNCH_LOCK=${LAUNCH_LOCK:-logs/riskkv_gpu_launch.lock}
MAX_WAIT_LOOPS=${MAX_WAIT_LOOPS:-720}
NAME=${NAME:-riskkv_v78_coverage_certificate_budgeted_m20_20260709}
POLICY=${POLICY:-configs/riskkv_task_policy_v78_coverage_certificate_budgeted_20260709.json}
...
{
  echo "[$(date)] v78 coverage-certificate watcher started"

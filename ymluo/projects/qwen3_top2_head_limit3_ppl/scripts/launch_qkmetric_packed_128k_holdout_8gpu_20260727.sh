...
OUTPUT="${OUTPUT:-$ROOT/results/20260727_qkmetric_packed_128k_holdout}"
QK_SHRINKAGE="${QK_SHRINKAGE:-0.5}"
SCORE_MODE="${SCORE_MODE:-pca_hierarchical_autoqmsetotal15z_qkmetric_packed_direct}"
...
run_case() {
  ...
  local log="$LOGS/${topic}_w${window}.log"

...
$LogPath = Join-Path $LogDir "retry_launch_qa_shortdecode_20260711.log"
    ...
    try {
        ...
        try {
            ...
            Invoke-Checked "scp-scripts" @(
                "scp",
                "scripts\launch_qa_shortdecode_smoke_20260711.sh",
                "scripts\watch_combine_qa_shortdecode_smoke_20260711.sh",
                "scripts\compare_smoke_to_baselines_20260711.py",
                "scripts\update_riskkv_live_dashboard_20260711.py",
                "${Remote}:${RemoteRoot}/scripts/"
            )
            Invoke-Checked "scp-doc" @(
                "scp",
                "..\..\doc\section157_qa_short_decode_speed_smoke_20260711.md",
                "${Remote}:/home/fdong/ymluo/doc/section157_qa_short_decode_speed_smoke_20260711.md"
            )
        }
        finally {
            Pop-Location
...
/home/fdong/miniconda3/envs/moe/bin/python -m py_compile src/run_controlled_public_kv_benchmark_v1.py scripts/update_riskkv_live_dashboard_20260711.py scripts/compare_smoke_to_baselines_20260711.py
/home/fdong/miniconda3/envs/moe/bin/python -m json.tool configs/riskkv_task_policy_v316_v300_qa_shortdecode_balanced_smoke_20260711.json >/dev/null
/home/fdong/miniconda3/envs/moe/bin/python -m json.tool configs/riskkv_task_policy_v317_v300_qa_shortdecode_aggressive_smoke_20260711.json >/dev/null
bash -n scripts/launch_qa_shortdecode_smoke_20260711.sh
bash -n scripts/watch_combine_qa_shortdecode_smoke_20260711.sh
chmod +x scripts/launch_qa_shortdecode_smoke_20260711.sh scripts/watch_combine_qa_shortdecode_smoke_20260711.sh
echo VALIDATION_OK
"@
...
nohup env SAMPLES=20 GPUS=0,1,2,3,4,5,6,7 bash scripts/launch_qa_shortdecode_smoke_20260711.sh > outputs/logs/launch_qa_shortdecode_smoke_20260711.log 2>&1 < /dev/null &
nohup bash scripts/watch_combine_qa_shortdecode_smoke_20260711.sh > outputs/logs/watch_combine_qa_shortdecode_smoke_20260711.log 2>&1 < /dev/null &

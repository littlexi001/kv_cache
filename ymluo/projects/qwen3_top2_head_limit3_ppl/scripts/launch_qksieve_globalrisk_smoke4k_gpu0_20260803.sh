...
OUTPUT="${OUTPUT:-$ROOT/results/20260803_globalrisk_smoke4k_gpu0_v1}"
VARIANTS="${VARIANTS:-qksieve_keymse_requestlocal_valuesketch16i4_wometric_residualrisk4_fulltopk_k1280,qksieve_keymse_requestlocal_valuesketch16i4_wometric_residualrisk4_globalalloc_fulltopk_k1280}"
GPU="${GPU:-0}"

...
HORIZON=${HORIZON:-64}
RUN_ROOT=$ROOT/results/20260724_countcap_dp4a_prefillindex_g${HORIZON}_2gpu
STANDARD=countcap_fullprompt_keypca_direct_qkvfused_prefillindex
DP4A=countcap_fullprompt_keypca_direct_qkvfused_dp4a_prefillindex
...
for spec in "0:8192" "1:16000"; do
  ...
  (
    orders=(
      "full_kv,$STANDARD,$DP4A"
      "$STANDARD,$DP4A,full_kv"
      "$DP4A,full_kv,$STANDARD"
    )

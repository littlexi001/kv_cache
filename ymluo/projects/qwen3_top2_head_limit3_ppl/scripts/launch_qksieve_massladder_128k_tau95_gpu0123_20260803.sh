...
OUTPUT="${OUTPUT:-${ROOT}/results/20260803_qksieve_massladder_128k_tau95_gpu0123_v1}"
...
CUDA_VISIBLE_DEVICES=0,1,2,3 "${PYTHON}" -u \
  ...
  --variants \
    qksieve_keymse_requestlocal_valuesketch16i4_massladder90,qksieve_keymse_requestlocal_valuesketch16i4_massladder95 \
  >"${OUTPUT}/run.log" 2>&1

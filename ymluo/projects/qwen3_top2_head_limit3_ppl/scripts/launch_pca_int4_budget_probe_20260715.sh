...
RUN_ROOT="${RUN_ROOT:-${ROOT}/results/20260715_pca_int4_budget_probe_32k_w0}"

mkdir -p "${RUN_ROOT}"
topics=(sports medicine sports medicine sports medicine sports medicine)
fractions=(0.005 0.005 0.01 0.01 0.02 0.02 0.01 0.01)
dimensions=(64 64 64 64 64 64 96 96)

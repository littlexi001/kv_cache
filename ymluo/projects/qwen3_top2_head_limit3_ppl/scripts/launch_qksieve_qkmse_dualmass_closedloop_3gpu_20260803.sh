...
OUTPUT="${OUTPUT:-${ROOT}/results/20260803_qksieve_qkmse_dualmass_closedloop_3gpu_v1}"
DATASET_CACHE_DIR="${DATASET_CACHE_DIR:-/home/fdong/ymluo/datasets/sklearn}"
VARIANTS="${VARIANTS:-qksieve_keymse_requestlocal_valuesketch16i4_wometric_massfloor950_affineres_fulltopk_k492,qksieve_qmse_requestlocal_dualmass975_affineres_k492}"
...
run_case 0 religion 4096 20261001 & pid0=$!
run_case 1 sports 32000 20261002 & pid1=$!
run_case 2 medicine 32000 20261003 & pid2=$!

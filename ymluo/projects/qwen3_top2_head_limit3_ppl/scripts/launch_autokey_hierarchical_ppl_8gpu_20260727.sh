...
OUTPUT_ROOT="${OUTPUT_ROOT:-$ROOT/results/20260727_autokey_hierarchical_ppl}"
LOG_DIR="$OUTPUT_ROOT/logs"
mkdir -p "$LOG_DIR"

topics=(sports medicine sports medicine computer space politics religion)
score_modes=(
...
labels=(
  autokey21_f06_sports
  autokey21_f06_medicine
  autokey26_f06_sports
  autokey26_f06_medicine
  autokey21_f06_computer
  autokey21_f06_space
  autokey21_f06_politics
  autokey21_f06_religion
)

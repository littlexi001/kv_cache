...
OUTPUT="${OUTPUT:-${ROOT}/results/20260803_qksieve_global_floor_rss_4gpu_v1}"
...
run_case() {
  ...
  CUDA_VISIBLE_DEVICES="${gpu}" "${PYTHON}" -u \
    ...
    --global_rss_tolerances 0.0025,0.005,0.01 \
    --global_rss_floor_k 1280 \
    --rss_safety_factors 1,2,4 \
    --minimum_top_k 1280 \
    --maximum_top_k 0 \
    --key_rate_budget 15 \
    --value_rank 16 \

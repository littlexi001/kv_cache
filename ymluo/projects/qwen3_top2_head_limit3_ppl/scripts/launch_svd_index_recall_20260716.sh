...
OUT=$ROOT/results/20260716_svd_index_recall_32k
...
run_topic() {
  ...
  CUDA_VISIBLE_DEVICES="$gpu" "$PYTHON" \
    ...
    --sample_stride 32 \
    --ranks 32,48,64 \
    > "outputs/logs/20260716_svd_index_recall_${topic}.log" 2>&1
}
...
"$PYTHON" src/summarize_svd_index_recall_20260716.py \
  ...
  > outputs/logs/20260716_svd_index_recall_summary.log 2>&1

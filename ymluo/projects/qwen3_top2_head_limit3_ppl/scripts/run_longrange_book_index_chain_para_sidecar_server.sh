...
OUT=/home/fdong/ymluo/projects/qwen3_top2_head_limit3_ppl/outputs/longrange_book_index_chain_para_sidecar_10k20k_v1_range_sdpa
mkdir -p "$OUT"
...
nohup python -u src/run_longrange_book_index_sparse_eval.py \
  ...
  --modes sink_recent,remote_tail_p4,book_auth_flat_p4,chain_authflat_p2_x4,chain_authflat_p2_x4_authadj1 \

...
TASKS="${TASKS:-qasper,multifieldqa_en,hotpotqa,2wikimqa,musique,passage_retrieval_en,passage_count}"
SAMPLES="${SAMPLES:-1}"
MAX_CONTEXT="${MAX_CONTEXT:-8192}"
MAX_NEW="${MAX_NEW:-32}"
TARGET_TOKENS="${TARGET_TOKENS:-16}"
MAX_LABEL_PAGES="${MAX_LABEL_PAGES:-6}"
BUDGET="${BUDGET:-512}"
OUT="outputs/causal_page_sparse_prefill_v6_${SAMPLES}shot_b${BUDGET}_${STAMP}"
LOG="outputs/logs/causal_page_sparse_prefill_v6_${SAMPLES}shot_b${BUDGET}_${STAMP}.log"

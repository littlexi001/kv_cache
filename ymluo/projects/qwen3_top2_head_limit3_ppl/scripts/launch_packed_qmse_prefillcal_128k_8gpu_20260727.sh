...
OUTPUT="${OUTPUT:-$ROOT/results/20260727_packed_qmse_prefillcal_128k}"
LOGS="$OUTPUT/logs"
mkdir -p "$LOGS"
...
run_case "0,1" mixed_a 0 &
pid0=$!
run_case "2,3" mixed_a 1 &
pid1=$!
run_case "4,5" mixed_b 0 &
pid2=$!
run_case "6,7" mixed_b 1 &
pid3=$!

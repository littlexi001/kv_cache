...
RUN_ROOT="${RUN_ROOT:-${PROJECT_ROOT}/results/20260731_qksieve_integer_gap_ppl_8gpu}"
...
VARIANTS="${VARIANTS:-qksieve_keymse_requestlocal_fixedalloc_b8_fulltopk_k1280,qksieve_keymse_requestlocal_fixedalloc_i112_41_fulltopk_k1280,qksieve_keymse_requestlocal_fixedalloc_i112_211_fulltopk_k1280,qksieve_keymse_requestlocal_fixedalloc_i96_22_fulltopk_k1280,qksieve_keymse_requestlocal_fixedalloc_b5_fulltopk_k1280}"

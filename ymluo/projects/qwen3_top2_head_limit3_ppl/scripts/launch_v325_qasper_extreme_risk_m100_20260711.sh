...
STAMP="${STAMP:-20260711_v325_qasper_extreme_risk_m100}"
...
launch_one() {
  ...
  nohup env \
    ...
    LABEL="$label" \
    STAMP="$STAMP" \
    POLICY="configs/riskkv_task_policy_v325_qasper_extreme_risk_20260711.json" \
    TASKS="$task" \
...
launch_one "v325_qasper_extreme_risk_qasper" "qasper"

echo "Submitted v325 qasper extreme-risk M100 job."

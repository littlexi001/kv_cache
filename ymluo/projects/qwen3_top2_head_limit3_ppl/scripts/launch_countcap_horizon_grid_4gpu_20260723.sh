...
PARENT_RUN=$ROOT/results/20260723_countcap_adakv16k_longbench_m20_8gpu
RUN_ROOT=$ROOT/results/20260723_countcap_horizon_grid_4gpu
...
log "queued: waiting for the AdaKV-compatible 16K pilot"
...
log "starting controlled prompt-length x generation-horizon grid"

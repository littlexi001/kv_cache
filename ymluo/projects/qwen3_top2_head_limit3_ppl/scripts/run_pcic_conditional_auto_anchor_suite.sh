...
echo "[conditional-auto-anchor] hard=${HARD_ANCHORS} war=${WAR_ANCHORS} monte=${MONTE_ANCHORS} margin=${ANCHOR_ACCEPT_MARGIN}"
...
cases = [
    ("hard_top2_32to64", pathlib.Path("outputs/server_pcic_hardtopic_b4_horizongate_top2_timingv2_eval128_seed64_eager/pcic_r_blockwise_results.csv")),
    ("hard_auto_anchor", pathlib.Path("outputs/server_pcic_hardtopic_b4_horizongate_cascade64to128_top2_autoanchor_eval128_seed64_eager/pcic_r_blockwise_results.csv")),
    ("hard_cond_auto_anchor", pathlib.Path("outputs/server_pcic_hardtopic_b4_horizongate_condautoanchor_eval128_seed64_eager/pcic_r_blockwise_results.csv")),
    ...
    ("war_cond_auto_anchor", pathlib.Path("outputs/server_pcic_war_b2_horizongate_condautoanchor_seed64_eager/pcic_r_blockwise_results.csv")),
    ...
    ("monte_cond_auto_anchor", pathlib.Path("outputs/server_pcic_monte_b2_horizongate_condautoanchor_seed64_eager/pcic_r_blockwise_results.csv")),
]

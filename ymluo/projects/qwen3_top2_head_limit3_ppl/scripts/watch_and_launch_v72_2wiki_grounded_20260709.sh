...
LOG=${LOG:-logs/watch_and_launch_v72_2wiki_grounded_20260709.log}
LAUNCH_LOCK=${LAUNCH_LOCK:-logs/riskkv_gpu_launch.lock}
MAX_WAIT_LOOPS=${MAX_WAIT_LOOPS:-720}
NAME=${NAME:-riskkv_v72_2wiki_grounded_only_qasper_full_m20_20260709}
POLICY=${POLICY:-configs/riskkv_task_policy_v72_2wiki_grounded_only_qasper_full_20260709.json}
...
{
  echo "[$(date)] v72 2wiki grounded watcher started"

...
STAMP="${STAMP:-20260709_idf_flow_v14_m8}"
...
run_one() {
  ...
  mkdir -p "$out"
  echo "START label=$label scorer=$scorer page=$page budget=$budget idf_mix=$idf_mix gpu=$GPU samples=$SAMPLES $(date -Is)"
...
wait_for_gpu
run_one "v11_hybrid_late_mmr_p128" "hybrid_late_mmr" 128 512 0.0
run_one "v14_idf_flow_p128_mix065" "hybrid_late_mmr_idf_flow" 128 512 0.65
run_one "v14_idf_flow_p128_mix040" "hybrid_late_mmr_idf_flow" 128 512 0.40
run_one "v14_ms_idf_flow_p64_mix065" "hybrid_late_mmr_multiscale_idf_flow" 64 512 0.65

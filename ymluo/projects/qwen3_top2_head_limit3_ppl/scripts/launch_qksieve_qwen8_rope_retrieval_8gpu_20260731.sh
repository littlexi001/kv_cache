...
RUN_ROOT="${RUN_ROOT:-${PROJECT_ROOT}/results/20260731_qksieve_qwen8_rope_retrieval_8gpu}"
...
VARIANTS="${VARIANTS:-qksieve_keymse_requestlocal_fixedalloc_b8_fulltopk_k1280,qksieve_keymse_requestlocal_fixedalloc_fullprerope_b8_fulltopk_k1280,qksieve_keymse_requestlocal_fixedalloc_fullprerope_b10_fulltopk_k1280,qksieve_keymse_requestlocal_fixedalloc_fullprerope_b12_fulltopk_k1280}"

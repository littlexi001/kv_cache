...
GPUS="${GPUS:-2,4,6,7,0,1,3,5}"
RUNNER="${RUNNER:-scripts/run_riskkv_task_policy_v19_one_20260709.sh}"
STAMP="${STAMP:-20260712_m100_task_knapsack_v385_v393}"
LABEL="${LABEL:-v393_m100_task_knapsack_v385}"
POLICY="${POLICY:-configs/riskkv_task_policy_v393_m100_task_knapsack_v385_20260712.json}"
...
full_score = 0.3658
full_online = 3.0988
path = Path("outputs/riskkv_v19_v393_m100_task_knapsack_v385_20260712_m100_task_knapsack_v385_v393_m20_bDyn_pDyn/task_results.csv")
flag = Path("outputs/riskkv_v19_v393_m100_task_knapsack_v385_m100_gate_20260712.flag")
...
flag.write_text("1\n" if passed else "0\n", encoding="utf-8")
print(
    f"V393_M20_GATE score={score:.4f} vs_full={score/full_score:.2%} "
    f"kv={kv:.2%} speed_full={speed:.2f}x passed={passed}"
)
PY

if [[ "$(cat outputs/riskkv_v19_v393_m100_task_knapsack_v385_m100_gate_20260712.flag)" == "1" ]]; then
  launch_sync 100
else
  echo "SKIP v393 M100 because M20 gate failed $(date -Is)"
fi

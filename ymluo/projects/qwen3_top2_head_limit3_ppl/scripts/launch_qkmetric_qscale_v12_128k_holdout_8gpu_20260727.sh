...
OUTPUT="${OUTPUT:-$ROOT/results/20260727_qkmetric_qscale_v12_128k_holdout}"
SCORE_MODE="${SCORE_MODE:-pca_hierarchical_autoqmsetotal15z_qkmetric_qscale_packed_direct}"

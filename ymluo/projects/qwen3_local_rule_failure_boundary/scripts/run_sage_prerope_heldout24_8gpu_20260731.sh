...
RUN_ROOT="${RUN_ROOT:-${BASE}/outputs/20260731_sage_prerope_heldout24_8gpu}"
LENGTHS="${LENGTHS:-8192,16384,32768,65536}"
VARIANTS="${VARIANTS:-full_rope,rope_top2,local_global_blend25,local_global_postscore,pre_monotone25,pre_masspreserve25}"
SEED_BASE="${SEED_BASE:-32}"

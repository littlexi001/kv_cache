...
RUN_ROOT="${RUN_ROOT:-${BASE}/outputs/20260731_post_overfetch_pre_rerank_discovery_8gpu}"
VARIANTS="${VARIANTS:-full_rope,rope_top2,local_global_postscore,post2x_pre_rerank_postscore,post4x_pre_rerank_postscore,post2x_pre_rerank_masspreserve25}"
SEED_BASE="${SEED_BASE:-120}"

...
RUN_ROOT="${RUN_ROOT:-${BASE}/outputs/20260731_prerope_qksieve_budget_discovery_8gpu}"
LENGTHS="${LENGTHS:-8192,16384,32768,65536}"
VARIANTS="${VARIANTS:-full_rope,rope_top2,local_global_postscore,pre_masspreserve25}"

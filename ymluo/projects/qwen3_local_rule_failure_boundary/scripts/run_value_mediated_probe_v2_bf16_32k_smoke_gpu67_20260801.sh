...
# Unquantized BF16 causal-closure length extrapolation. Physical GPUs 6 and 7 only.
...
OUTPUT=${PROJECT}/outputs/20260801_value_mediated_singleton_v2_bf16_noop_32k_smoke_gpu67

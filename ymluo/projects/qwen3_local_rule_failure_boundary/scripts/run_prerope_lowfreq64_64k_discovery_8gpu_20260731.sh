...
RUN_ROOT="${RUN_ROOT:-${BASE}/outputs/20260731_prerope_lowfreq64_64k_discovery_8gpu}"
VARIANTS="${VARIANTS:-full_rope,local_global_postscore,lowfreq32_int2_postscore,lowfreq32_int4_postscore,lowfreq64_int2_postscore}"
SEED_BASE="${SEED_BASE:-112}"

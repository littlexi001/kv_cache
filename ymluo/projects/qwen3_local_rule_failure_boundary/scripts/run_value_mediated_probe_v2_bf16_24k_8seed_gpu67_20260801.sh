...
# Unquantized BF16 causal-closure expansion at 24K. Physical GPUs 6 and 7 only.
...
OUTPUT=${PROJECT}/outputs/20260801_value_mediated_singleton_v2_bf16_noop_24k_8seed_gpu67

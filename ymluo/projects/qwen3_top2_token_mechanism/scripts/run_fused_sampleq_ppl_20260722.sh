...
GPU=${1:?'usage: GPU SCORE_MODE TOPIC HISTORY_TOKENS EVAL_TOKENS OUTPUT_DIR [RANK] [CANDIDATE_FRACTION] [BUDGET_FRACTION]'}
...
RANK=${7:-48}
CANDIDATE_FRACTION=${8:-0.06}
BUDGET_FRACTION=${9:-0.02}

...
OUTPUT_ROOT=${1:-${ROOT}/outputs/qkmetric_128k_20260721}
LOG_ROOT=${ROOT}/artifacts/20260721_numeric_pruning_frontier/qkmetric_ppl_logs
...
for index in "${!topics[@]}"; do
  ...
  bash "${ROOT}/scripts/run_qkmetric_128k_20260721.sh" \
    "${gpu_pair}" "${topic}" 1024 "${OUTPUT_ROOT}" 64 0.06 \

...
\begin{itemize}
  \item Starting from covariance-weighted score geometry, we expose its
  full-rank factors as exact biorthogonal coordinates and formulate per-head
  mixed-bit indexing as a hardware-visible rate-distortion problem.

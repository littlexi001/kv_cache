...
SAKI states this covariance-weighted rank-$r$ optimum for floating-point
low-rank Key indexing \citep{zhang2026saki}.  QKSieve uses the $r=d$ factors
as an exactly score-preserving coordinate system and allocates physical
mixed-bit rate within that system.

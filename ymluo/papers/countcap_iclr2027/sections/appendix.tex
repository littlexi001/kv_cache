...
Allocation & Reference: logit-MSE; deployment: Key-MSE \\
...
\texttt{qksieve\_global\_qkbalanced\_keymse\_wmma\_sampled} (deployment).
...
\subsection{Persistent-KV workload contract (to be completed)}
...
\begin{table}[h]
\caption{Pre-registered persistent-KV systems evaluation.  All entries are
currently TODO; each row uses the same quality-checked method and matched dense
baseline.}
